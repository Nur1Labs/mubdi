...
{
    BOOST_CHECK(TestSplitHost("www.nur1labs.org", "www.nur1labs.org", -1));
    BOOST_CHECK(TestSplitHost("[www.nur1labs.org]", "www.nur1labs.org", -1));
    BOOST_CHECK(TestSplitHost("www.nur1labs.org:80", "www.nur1labs.org", 80));
    BOOST_CHECK(TestSplitHost("[www.nur1labs.org]:80", "www.nur1labs.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:46100", "127.0.0.1", 46100));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:46100", "127.0.0.1", 46100));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:46100", "::ffff:127.0.0.1", 46100));
    BOOST_CHECK(TestSplitHost("[::]:46100", "::", 46100));
    BOOST_CHECK(TestSplitHost("::46100", "::46100", -1));
    BOOST_CHECK(TestSplitHost(":46100", "", 46100));
    BOOST_CHECK(TestSplitHost("[]:46100", "", 46100));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:46100", "127.0.0.1:46100"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:46100", "[::]:46100"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
