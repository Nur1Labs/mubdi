...
static const CMuBdIAddress addr1 ("caii8XAE1rcdCQfkv9w22n8Y9RxgaJnrDD");
static const CMuBdIAddress addr2 ("caiKfv1FVp69yZMDzeuugvfZ9pzYiMv1bs");
static const CMuBdIAddress addr1C("cairHK9ezAAUVExFDpZ7EE1xWpPskgp1gP");
static const CMuBdIAddress addr2C("caiVSAoc2whPFjZVAZ1pQbXPJk1LRrDC8Q");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CMuBdIAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CMuBdISecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
