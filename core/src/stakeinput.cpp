...
bool CMuBdIStake::GetTxFrom(CTransaction& tx) const
{
    tx = txFrom;
    return true;
}
...
CAmount CMuBdIStake::GetValue() const
{
    return txFrom.vout[nPosition].nValue;
}

bool CMuBdIStake::CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal)
{
...
CDataStream CMuBdIStake::GetUniqueness() const
{
