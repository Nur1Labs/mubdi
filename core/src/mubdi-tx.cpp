...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MuBdI Core mubdi-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mubdi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mubdi transaction") + "\n" +
                               "  mubdi-tx [options] -create [commands]   " + _("Create hex-encoded mubdi transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mubdi transaction
