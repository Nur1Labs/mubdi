...
#ifndef MUBDI_COINS_H
#define MUBDI_COINS_H
...
/** 
    ...
    ****Note - for MuBdI we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of mubdi coming in to a transaction
