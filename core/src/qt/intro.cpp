...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/mubdi"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MuBdI Core"),
     ...
     * override -datadir in the mubdi.conf file in the default data directory
     * (to be consistent with mubdid behavior)
     */
