...
#ifndef MUBDI_QT_MUBDIUNITS_H
#define MUBDI_QT_MUBDIUNITS_H
...
/** MuBdI unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MuBdIUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MuBdIUnits(QObject* parent);

    /** MuBdI units.
      @note Source: https://en.mubdi.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        MuBdI,
        mMuBdI,
    ...
    //! Short name
    static QString name(int unit, bool isZMuBdI = false);
    //! Longer description
    ...
    static QString floorWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZMuBdI = false);
    static QString floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZMuBdI = false);
...
typedef MuBdIUnits::Unit MuBdIUnit;

#endif /* MUBDI_QT_MUBDIUNITS_H */
