...
#ifndef MUBDI_CORE_NEW_GUI_MUBDIGUI_H
#define MUBDI_CORE_NEW_GUI_MUBDIGUI_H
...
/**
  MuBdI GUI main class. This class represents the main window of the MuBdI UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MuBdIGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MuBdIGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~MuBdIGUI();
...
public Q_SLOTS:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a mubdi wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif /* MUBDI_CORE_NEW_GUI_MUBDIGUI_H */
