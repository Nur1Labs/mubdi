...
#include "qt/mubdi/forms/ui_sendchangeaddressdialog.h"
    ...
    ui(new Ui::SendChangeAddressDialog)
{
    ...
    ui->labelMessage->setText(tr("The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" CArIa address"));
    ui->labelMessage->setProperty("cssClass", "text-main-grey");

    ui->lineEditAddress->setPlaceholderText("Enter CArIa  address (e.g caiFR83SQbiezrW72hjc… ");
