...
#include "qt/mubdi/coincontrolmubwidget.h"
#include "qt/mubdi/forms/ui_coincontrolmubwidget.h"

CoinControlMuBdIWidget::CoinControlMuBdIWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlMuBdIWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select CAI Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("CAI");
    ...
    ui->labelValueAfter->setText("0.00 CAI");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 CAI");
    ui->labelValueFee->setText("0.00 CAI");
...
CoinControlMuBdIWidget::~CoinControlMuBdIWidget()
{
    delete ui;
}
