...
#include "qt/mubdi/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 46031");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("46100");
    } else {
        ui->lineEditPort->setText("46031");
    }
...
bool MasterNodeWizardDialog::createMN(){
    if (walletModel) {
        ...
        CMuBdISecret mnKey = CMuBdISecret(secret);
