...
#include "config/mubdi-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalMuBdI = 0;
    qint64 totalZMuBdI = 0;
    QList<qreal> valuesMuBdI;
    QList<qreal> valueszMuBdI;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(MuBdIGUI* _window);
    ~DashboardWidget();
