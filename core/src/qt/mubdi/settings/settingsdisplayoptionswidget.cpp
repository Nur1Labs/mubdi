...
#include "qt/mubdi/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(MuBdIGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsDisplayOptionsWidget)
{
    ...
    ui->comboBoxUnit->setModel(new MuBdIUnits(this));
