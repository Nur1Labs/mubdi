...
#include "qt/mubdi/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(MuBdIGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    settingsMubToolWidget = new SettingsMubToolWidget(window, this);
    ...
    ui->stackedWidgetContainer->addWidget(settingsMubToolWidget);
...
void SettingsWidget::loadWalletModel(){
    ...
    this->settingsMubToolWidget->setWalletModel(this->walletModel);
...
void SettingsWidget::onBipToolClicked() {
    ui->stackedWidgetContainer->setCurrentWidget(settingsMubToolWidget);
