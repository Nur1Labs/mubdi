...
#include "qt/mubdi/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/mubdi/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MuBdIGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MuBdIGUI::handleRestart()
