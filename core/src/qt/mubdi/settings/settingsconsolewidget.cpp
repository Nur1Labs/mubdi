...
#include "qt/mubdi/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/mubdi/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MuBdIGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the MuBdI RPC console.") + "<br>" +
