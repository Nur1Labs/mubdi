...
#include "qt/mubdi/settings/settingsnetworkwidget.h"
#include "qt/mubdi/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/mubdi/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MuBdIGUI* _window, QWidget *parent) :
