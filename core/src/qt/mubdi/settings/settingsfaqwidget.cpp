...
#include "qt/mubdi/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://nur1labs.org/");
    ...
    connect(ui->pushButtonFaq11, SIGNAL(clicked()), this, SLOT(onFaq11Clicked()));
...
void SettingsFaqWidget::onFaq11Clicked(){
    ui->scrollAreaFaq->verticalScrollBar()->setValue(ui->widgetFaq11->y());
}
