...
#include "qt/mubdi/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/mubdi/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MuBdIGUI* _window, QWidget *parent) :
