...
#ifndef MUBDI_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MUBDI_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif /* MUBDI_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H */
