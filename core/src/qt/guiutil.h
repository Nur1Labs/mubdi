...
#ifndef MUBDI_QT_GUIUTIL_H
#define MUBDI_QT_GUIUTIL_H
...
/** Utility functions used by the MuBdI Qt UI.
 */
namespace GUIUtil
{
...
// Render MuBdI addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZMuBdI = false);
...
// Parse "mubdi:" URI into recipient object, return true on successful parsing
