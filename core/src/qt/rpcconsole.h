...
#ifndef MUBDI_QT_RPCCONSOLE_H
#define MUBDI_QT_RPCCONSOLE_H
...
public Q_SLOTS:
    ...
    void showRepair();
    /** Open external (default) editor with mubdi.conf */
    void showConfEditor();
