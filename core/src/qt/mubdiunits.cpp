...
QString MuBdIUnits::id(int unit)
{
    switch (unit) {
    case MuBdI:
        return QString("caria");
    case mMuBdI:
        return QString("mcaria");
    case uMuBdI:
        return QString::fromUtf8("ucaria");
    default:
        return QString("???");
    }
}
...
QString MuBdIUnits::name(int unit, bool isZMuBdI)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case MuBdI:
            return z + QString("CAI");
        case mMuBdI:
            return z + QString("mCAI");
        case uMuBdI:
            return z + QString::fromUtf8("μCAI");
        default:
            return QString("???");
        }
    } else if (Params().NetworkID() == CBaseChainParams::LIESE) {
        switch (unit) {
        case MuBdI:
            return z + QString("lCAI");
        case mMuBdI:
            return z + QString("mlCAI");
        case uMuBdI:
            return z + QString::fromUtf8("μlCAI");
        default:
            return z + QString("???");
        }
    } else if (Params().NetworkID() == CBaseChainParams::ARIN) {
        switch (unit) {
        case MuBdI:
            return z + QString("aCAI");
        case mMuBdI:
            return z + QString("maCAI");
        case uMuBdI:
            return z + QString::fromUtf8("μaCAI");
        default:
            return z + QString("???");
        }
    } else if (Params().NetworkID() == CBaseChainParams::GAZA) {
        switch (unit) {
        case MuBdI:
            return z + QString("gCAI");
        case mMuBdI:
            return z + QString("mgCAI");
        case uMuBdI:
            return z + QString::fromUtf8("μgCAI");
        default:
            return z + QString("???");
        }
    } else {
        switch (unit) {
        case MuBdI:
            return z + QString("tCAI");
        case mMuBdI:
            return z + QString("mtCAI");
        case uMuBdI:
            return z + QString::fromUtf8("μtCAI");
        default:
            return QString("???");
        }
    }
...
QString MuBdIUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MuBdI:
            return QString("CAI");
        case mMuBdI:
            return QString("Milli-CAI (1 / 1" THIN_SP_UTF8 "000)");
        case uMuBdI:
            return QString("Micro-CAI (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else if (Params().NetworkID() == CBaseChainParams::LIESE) {
        ...
        case MuBdI:
            return QString("lCAI");
        case mMuBdI:
            return QString("Milli-LieseCAI (1 / 1" THIN_SP_UTF8 "000)");
        case uMuBdI:
            return QString("Micro-LieseCAI (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else if (Params().NetworkID() == CBaseChainParams::ARIN) {
        ...
        case MuBdI:
            return QString("aCAI");
        case mMuBdI:
            return QString("Milli-ArinCAI (1 / 1" THIN_SP_UTF8 "000)");
        case uMuBdI:
            return QString("Micro-ArinCAI (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else if (Params().NetworkID() == CBaseChainParams::GAZA) {
        ...
        case MuBdI:
            return QString("gCAI");
        case mMuBdI:
            return QString("Milli-GaZaCAI (1 / 1" THIN_SP_UTF8 "000)");
        case uMuBdI:
            return QString("Micro-GaZaCAI (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MuBdI:
            return QString("TestCAIs");
        case mMuBdI:
            return QString("Milli-TestCAI (1 / 1" THIN_SP_UTF8 "000)");
        case uMuBdI:
            return QString("Micro-TestCAI (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
