...
#ifndef MUBDI_QT_ASKPASSPHRASEDIALOG_H
#define MUBDI_QT_ASKPASSPHRASEDIALOG_H

#include <QDialog>
#include "qt/mubdi/prunnable.h"
...
public:
    ...
    enum class Context {
        ...
        Send_MuBdI,     /** Send MuBdI */
        Send_zMuBdI,    /** Send MuBdI */
        BIP_38,         /** BIP38 menu */
...
#endif /* MUBDI_QT_ASKPASSPHRASEDIALOG_H */
