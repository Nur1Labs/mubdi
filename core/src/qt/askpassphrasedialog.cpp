...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR CAI</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                MuBdIGUI* window = static_cast<MuBdIGUI*>(parentWidget());
...
{
    MuBdIGUI* gui = static_cast<MuBdIGUI*>(parentWidget());
...
{
    hide();
    static_cast<MuBdIGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MuBdI will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your CAIs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
