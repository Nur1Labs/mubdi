...
#ifndef MUBDI_QT_OPTIONSMODEL_H
#define MUBDI_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for MuBdI client.
...
Q_SIGNALS:
    ...
    void anonymizeMuBdIAmountChanged(int);
