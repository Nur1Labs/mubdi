...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MuBdI features */
        {"mubdi", "listmasternodes", &listmasternodes, true, true, false},
        {"mubdi", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mubdi", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mubdi", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mubdi", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mubdi", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mubdi", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mubdi", "masternodedebug", &masternodedebug, true, true, false},
        {"mubdi", "startmasternode", &startmasternode, true, true, false},
        {"mubdi", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mubdi", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mubdi", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mubdi", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mubdi", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mubdi", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mubdi", "preparebudget", &preparebudget, true, true, false},
        {"mubdi", "submitbudget", &submitbudget, true, true, false},
        {"mubdi", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mubdi", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mubdi", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mubdi", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mubdi", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mubdi", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mubdi", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mubdi", "checkbudgets", &checkbudgets, true, true, false},
        {"mubdi", "mnsync", &mnsync, true, true, false},
        {"mubdi", "spork", &spork, true, true, false},
        {"mubdi", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> mubdi-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:46031/\n";
}
