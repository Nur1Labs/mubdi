...
#ifndef MUBDI_KEYSTORE_H
#define MUBDI_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/mubdi/bips/blob/master/bip-0013.mediawiki
