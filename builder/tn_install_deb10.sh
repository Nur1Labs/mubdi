...
echo -e "Preparing the VPS to setup. ${CYAN}$COIN_NAME${NC} ${RED}Test Nodes${NC}"
...
#main
cd ~/coins/cai_tokenstream/core && ./mubdi.sh && ./configure --enable-cxx --disable-shared --enable-hardening --disable-tests --without-gui --with-incompatible-bdb --with-unsupported-ssl && make && make install
}
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "$COIN_NAME Token Nodes is up and running listening on port ${GREEN}$COIN_PORT${NC}."
