...
#zipped simple
cd ~/coins/dev/core && unzip plugin.zip
#chmod
cd ~/coins/dev/core && chmod 755 -R build-aux && chmod 755 -R depends && chmod 755 -R share && chmod 755 -R mubdi.sh
cd ~/coins/dev/core && chmod 755 -R src/leveldb && chmod 755 -R src/univalue
#main
cd ~/coins/dev/core && ./mubdi.sh && ./configure --enable-cxx --enable-shared --enable-hardening --with-incompatible-bdb --with-unsupported-ssl && make && make install
}
